...
import { CriticalBarangaysChart } from "@/components/dashboard/CriticalBarangaysChart";
...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {ranking.data && (
        <Panel title="Top Critical Barangays">
          <CriticalBarangaysChart rows={ranking.data} />
        </Panel>
      )}
